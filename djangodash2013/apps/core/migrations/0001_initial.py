...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Mosaic'
        db.create_table(u'core_mosaic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image_path', self.gf('django.db.models.fields.FilePathField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.FacebookCustomUser'])),
        ))
        db.send_create_signal(u'core', ['Mosaic'])


    def backwards(self, orm):
        # Deleting model 'Mosaic'
        db.delete_table(u'core_mosaic')
    ...
    models = {
        ...
        u'core.mosaic': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_path': ('django.db.models.fields.FilePathField', [], {'max_length': '100'}),
