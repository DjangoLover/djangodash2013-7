...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mosaic.image_path'
        db.delete_column(u'core_mosaic', 'image_path')

        # Adding field 'Mosaic.image'
        db.add_column(u'core_mosaic', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Mosaic.image_path'
        db.add_column(u'core_mosaic', 'image_path',
                      self.gf('django.db.models.fields.FilePathField')(default='/', max_length=100),
                      keep_default=False)

        # Deleting field 'Mosaic.image'
        db.delete_column(u'core_mosaic', 'image')
